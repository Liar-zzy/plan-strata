...
> The first-release draft and P002 evidence below are historical. Current
> installation uses `main`; see the [README](../README.md#choose-the-source) and
> [schema 2 migration notes](v0.2.0-alpha.1.md). A main-branch push does not create
> a release or authorize reuse of the old release title below.
