...
> 后续更新：[P006 检查](../plans/ex-plans/P006/check/T01-check-001.md)记录 main hotfix
> 同步时的复验；再之后的 Issue 独立接手改动见 [P007 冷启动记录](validation-issue-handoff.md)。
> 下文的 49 项结果保留为 P004 当时的历史记录，不作为后续版本的新验证。
